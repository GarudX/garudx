        ...
        <>
          <Button
            ...
            className={cn(
              ...
              // Variant styles
              variant === 'standard' && [
                'bg-gray-800/80 hover:bg-gray-800/95',
          ...
          {items.map((_, index) => (
            <Button
              ...
              className={cn(
                ...
                variant === 'standard' && [
                  'bg-gray-800/80 hover:bg-gray-800/95',
                  index === currentIndex ? 'bg-white w-4' : 'hover:bg-gray-800/60'
                ],
                ...
                variant === 'technical' && [
                  ...
                  index === currentIndex 
                    ? 'bg-blue-500/80 w-6 border-blue-500' 
                    : 'bg-gray-800/60 hover:bg-blue-500/30'
                ],
