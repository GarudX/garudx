...
const mainNav = [
  { 
    name: 'SERVICES', 
    href: '/services',
    icon: <FiTarget className="text-electricBlue" />,
    children: [
  ...
  { 
    name: 'PRODUCTS', 
    href: '/products',
    icon: <FiShield className="text-electricBlue" />
  },
  { 
    name: 'TECH SPECS', 
    href: '/specifications',
    icon: <FiGrid className="text-electricBlue" />
  },
  { 
    name: 'COMPONENTS', 
    href: '/components',
    ...
    >
      <div className="container mx-auto px-5">
        <div className="relative overflow-hidden rounded-xl shadow-xl 
                       bg-gradient-to-br from-darkSlate/70 to-darkSlate/90
          ...
          <div className="flex items-center justify-between px-5 py-4">
                        ...
                        {activeDropdown === item.name && (
                          <motion.div
                            ...
                            className="absolute mt-2 w-64 overflow-hidden z-20 
                                     ...
                                     bg-gradient-to-br from-darkSlate/80 to-darkSlate/95
                                     backdrop-filter backdrop-blur-xl 
            ...
            <button 
              onClick={toggleMenu}
              className="p-2 rounded-md bg-darkSlate/80 text-gray-300 hover:text-white md:hidden focus:outline-none backdrop-filter backdrop-blur-sm"
